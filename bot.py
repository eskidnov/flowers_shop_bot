...
def callbacks(message):
    bot.send_message(message.chat.id, '*Елена,12.09.2017*,/n Санкт-Петербург,/n _«Начну  сразу со слов благодарности! За честь и порядочность, за добросовестно выполненный заказ, за оперативность и тактичность. Заказ был необычный, траурные цветы. Так случилось-потеряли мы близкого человека, подругу, дружба с которой связывала более 60 лет! И приехать проститься нет возможности. В интернете нашла прекрасно оформленный Ваш сайт, позвонила, Услышав приятный девичий голос я поняла- все сложится как я и хотела. С прекрасно оформленной большой корзиной роз мы смогли с Вашей помощью проститься с близким человеком, частички наших сердец были в тот момент рядом. Спасибо Вам большое!»
_', reply_markup=back_keyboard)
